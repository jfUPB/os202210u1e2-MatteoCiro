...
$(D_EXAMPLE)/main.out: $(D_EXAMPLE)/main.c $(D_OBS)/observer.o $(D_OBS)/subject.o $(D_MODELS)/jirafa.o $(D_MODELS)/hiena.o
	@$(CC) $(CFLAGS) -o $@ $^

$(D_MODELS)/jirafa.o: $(D_MODELS)/jirafa.c $(D_OBS)/observer.o $(D_OBS)/subject.o
	@$(CC) $(CFLAGS) $^ -c -o $@

$(D_MODELS)/hiena.o: $(D_MODELS)/hiena.c $(D_OBS)/observer.o
	@$(CC) $(CFLAGS) $^ -c -o $@
